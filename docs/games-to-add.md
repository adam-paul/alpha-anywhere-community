...
## How to Get Private Server Codes

1. Go to the game on Roblox.com
2. Click the "..." menu → "Create Private Server" (may require Robux)
3. Configure the private server, then copy the share link
4. Extract the code from `https://www.roblox.com/share?code=XXXXXXXX&type=Server`

## Adding a Game to the Database

```sql
INSERT INTO games (id, title, thumbnail_url, type, engagement_category, launch_url, private_server_share_code, description)
VALUES (
  'game-slug',
  'Game Title',
